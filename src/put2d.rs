    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match split[0] {
            "0" => Ok(Self::TYPE0 { entry: Type0 { 
                ...
                unknown_9: split[10].parse().unwrap_or_default() } }), // to handle an undocumented error in cursor.put2d
            "1" => Ok(Self::TYPE1 { entry: Type1 { 
                unknown_1: split[1].parse().unwrap(),
